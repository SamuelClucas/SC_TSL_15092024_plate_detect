...
```
This gave 'tuple' object is not callable error.
...
```{python}
model, _, _ = load_model(save_dir, 2, 'checkpoint_epoch_9')
model.eval()  # Set model to evaluation mode
plot_prediction(model, dataset_validation, device, 15, save_dir, 'checkpoint_epoch_9')
```
