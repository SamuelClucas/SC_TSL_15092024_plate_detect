...
print("\n -end-")
```
The keys in metric_logger.meters are 'loss, loss_classifier, loss_box_reg, loss_objectness, loss_rpn_box_reg'. 'train_one_epoch' overwrites the meters value throughout training by making a call to MetricLogger.update(). 
...
That's the 'plot_training_loss' sorted. Now for the 'eval_metrics'...
