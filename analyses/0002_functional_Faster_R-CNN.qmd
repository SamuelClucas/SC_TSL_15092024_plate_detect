...
*Note:* This function uses train_one_epoch() from [engine.py](../src/torchvision_deps/engine.py) in torchvision_deps. I later modify this function, and so I define it locally prior to these modifications before *my* train function to preserve its development through time.
```{python}
import math
import sys
import time
...
```{python}
model, optimizer, epoch = helper_training_functions.load_model('checkpoints/', num_class, 'checkpoint_epoch_0')
...
I have realised numerous mistakes: \
