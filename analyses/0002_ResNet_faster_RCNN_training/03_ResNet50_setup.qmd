...
Here, I attempt to train a Resnet50 faster RCNN model for 10 epochs - using src/Plate_Image_Dataset.py and src/helper_training_functions.py - then evaluate its mean average precision and recall, to be visualised in a line graph.
...
import external_deps.utils as utils
from external_deps.engine import train_one_epoch, evaluate 
import os
