...
---
## Purpose:
I made the mistake of saving my image labels in PASCAL VOC format (as xml files). It's convenient to read data from csv files when creating a custom dataset class using pytorch's [dataloader](https://pytorch.org/tutorials/beginner/basics/data_tutorial.html). Hence, I had to store the bounding box vertices' coordinates and class label in a csv file.
